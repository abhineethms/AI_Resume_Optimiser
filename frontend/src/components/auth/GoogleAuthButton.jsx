...
const GoogleAuthButton = ({ onSuccess, onError, buttonText = "Sign in with Google" }) => {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="w-full flex items-center justify-center px-4 py-3 border border-blue-500 text-blue-500 bg-transparent hover:bg-blue-50 hover:bg-opacity-10 disabled:opacity-70 rounded-lg font-semibold transition-all duration-200 mb-4"
    >
      {isLoading ? (
        <>
